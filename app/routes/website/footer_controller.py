...
@website_footer_bp.route("/", methods=["GET"], strict_slashes=False)
...
@website_footer_bp.route("/<int:id>", methods=["GET"])
def get_contact(id):
...
@website_footer_bp.route("/<int:id>", methods=["PUT"])
...
@website_footer_bp.route("/<int:id>", methods=["DELETE"])
